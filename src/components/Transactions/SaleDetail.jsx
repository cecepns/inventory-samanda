...
import { Calendar, User, UserCheck, FileText } from 'lucide-react';
      ...
      <div className="bg-green-50 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium">{new Date(sale.sale_date).toLocaleDateString('id-ID')}</span>
          </div>
          <div className="flex items-center space-x-2">
            <UserCheck className="w-4 h-4 text-green-600" />
            <span className="text-gray-600">Pelanggan:</span>
            <span className="font-medium">{sale.customer_name || 'Tanpa Pelanggan'}</span>
          </div>
          <div className="flex items-center space-x-2">
